...
namespace RazaBookingSystem.Migrations
{
    /// <inheritdoc />
    public partial class HBSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_attendances", x => new { x.Id, x.BookingId });
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HubId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    HubName = table.Column<int>(type: "int", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_userDetails", x => new { x.UserId, x.AttendanceId });
                })
                .Annotation("MySQL:Charset", "utf8mb4");
